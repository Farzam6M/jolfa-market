...
const PERMISSIONS = {
  ...
  ORDERS_REFUND: 'orders:refund', // admin/super_admin: POST /orders/:id/refund (delivered-order refund) + PATCH /admin/payment-refunds/:id/mark-processed
...
const ROLE_PERMISSIONS = {
  ...
  SELLER: [
    ...
    PERMISSIONS.WALLET_WITHDRAW_SELF,
  ...
  ADMIN: [
    ...
    PERMISSIONS.ORDERS_READ_ANY, PERMISSIONS.ORDERS_UPDATE_STATUS, PERMISSIONS.ORDERS_REFUND,
